...
export function TopBar() {
  ...
  return (
    <header className="bg-stone-900 border-b border-stone-800 sticky top-0 z-30 pt-safe">
      <div className="h-14 flex items-center px-4 gap-3">
        ...
        <div className="flex items-center gap-2 flex-1">
          <img src="/bee-icon.png" alt="Bee Forest" style={{ height: '42px', objectFit: 'contain' }} />
