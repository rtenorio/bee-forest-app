...
const navItems: NavItem[] = [
  ...
  { to: '/lotes', label: 'Rastreabilidade Mel', icon: '🫙', end: true, roles: ['master_admin', 'socio', 'responsavel'] },
  ...
  { to: '/financeiro', label: 'Financeiro', icon: '💰', end: true, roles: ['master_admin', 'socio', 'responsavel'] },
  { to: '/financeiro', label: 'Dashboard Financeiro', icon: '📈', end: true, roles: ['master_admin', 'socio', 'responsavel'], indent: true },
  { to: '/financeiro/producao', label: 'Produções', icon: '🍯', end: false, roles: ['master_admin', 'socio', 'responsavel'], indent: true },
  { to: '/financeiro/custos', label: 'Custos', icon: '💸', end: false, roles: ['master_admin', 'socio', 'responsavel'], indent: true },
